<%-- 
    ...
    Created on : 06-10-2020, 15:20:45
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link pagina-principal py-4 px-4" id="inicio" href="estadisticas.jsp">Estadísticas <span class="sr-only">(current)</span></a>
                    </li> 
                </ul>
