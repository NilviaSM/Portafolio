                ...
                <div class="form-row bg-light text-center">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>                                    
                                    <td><c:out value = "${id_reserva}"/></td>
                                    <td><c:out value = "${f_reserva}"/></td>
                                    <td><c:out value = "${c_hues}"/></td>
                                    <td><c:out value = "${c_habi}"/></td>                                    
                                    <td><c:out value = "${fi_reserva}"/></td> 
                                    <td><c:out value = "${fs_reserva}"/></td>                                    
                                    <td><c:out value = "${nm_reserva}"/></td>                                    
                                    <td>$<c:out value = "${mt_reserva}"/></td>                                    
                                </tr>                                
                            </tbody>
                        </table>
                    </div>                        
