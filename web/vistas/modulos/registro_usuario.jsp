<%-- 
    ...
    Created on : 06-10-2020, 15:12:45
            ...
            <section class="container border bg-secondary">
                ...
                <div class="row text-center pt-5">
                    ...
                    <div class="col-lg-6 col-md-2 col-sm-1">
                        <a href="registrar_proveedor.jsp" class="btn btn-info boton-entrar-sesion">Registrar Proveedor</a>
                    </div>
                    <div class="col-lg-6 col-md-2 col-sm-1">
                        <a href="registrar_empleado.jsp" class="btn btn-info boton-entrar-sesion">Registrar Empleado</a>
                    </div>               
                </div>
                <div class="row text-center py-5">
                    <div class="col-lg-4 col-md-2 col-sm-1">
                        <!--<a href="respuestas/listar_clientes.jsp" class="btn btn-info boton-entrar-sesion">Lista de Clientes</a>-->
                        <form method="POST" action="/Login_Hostal/ListarClientes" accept-charset=utf-8>
                            <input type="submit" name="btn_listar_clientes" value="Lista de Clientes" class="btn btn-info boton-entrar-sesion">
                        </form>
                    </div>
                    <div class="col-lg-4 col-md-2 col-sm-1">
                       <form method="POST" action="/Login_Hostal/ListarProveedor" accept-charset=utf-8>
                            <input type="submit" name="btn_listar_proveedor" value="Lista de Proveedores" class="btn btn-info boton-entrar-sesion">
                        </form>
                    </div>
                    <div class="col-lg-4 col-md-2 col-sm-1">
                         <form method="POST" action="/Login_Hostal/ListarEmpleados" accept-charset=utf-8>
                            <input type="submit" name="btn_listar_empleado" value="Lista de Empleados" class="btn btn-info boton-entrar-sesion">
                        </form>
                    </div>               
                </div>
            </section>            
