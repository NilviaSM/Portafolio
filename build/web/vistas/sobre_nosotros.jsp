<%-- 
    ...
    Created on : 06-10-2020, 12:55:04
...
<html lang="es-ES">
    ...
    <body>        
        ...
        <main class="fondo-principal text-center text-light salto-linea">            
            <section class="container border bg-secondary text-justify">
                <h1 class="display-0 py-0 text-capitalize font-italic text-center">
                    Sobre Nosotros
                </h1>
                <div align="center"><img src="../img/hostal.jpg" class="my-3" alt=""/></div>
                <span class="text-light mx-0 my-0">
                    Hostal Doña Clarita es una inmejorable alternativa de alojamiento económico para empresas, que cumple con las mejores condiciones de hospitalidad, confortabilidad y diseño. Todo para dar una experiencia única a nuestras empresas, acercándolos a las nuevas tendencias de alojamiento en el mundo.
                    Nos situamos en un punto neurálgico de la ciudad, con acceso a locomoción colectiva que se dirige a cada punto de la ciudad. Tras años de experiencia con Hostal Doña Clarita, decidimos crear un lugar que se transformara en un punto de encuentro tanto para huéspedes como penquistas: hostal Doña Clarita. Motivados por la idea de crear un espacio lúdico y acogedor  , construimos una cafetería  vanguardista, cargada de arte, color y diseño.  Te esperamos con productos innovadores y 100% caseros.
                </span>
                <h4 class="display-3 text-light py-3 text-capitalize font-italic">
