<%-- 
    ...
    Created on : 06-10-2020, 15:30:01
        ...
        <nav class="navbar navbar-expand-xl text-center text-light mod-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">                        
                        <a class="nav-link py-4 px-4 boton-navbar" href="Login_Hostal/vistas/inicio_sesion.jsp">Cerrar sesión</a>
                    </li>  
                </ul>
            </div>
        </nav>
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="username" minlength="3" placeholder="Usuario"required="">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputEmail4">Nombre Completo*</label>
                            <input type="text" class="form-control" name="nombre" minlength="3" placeholder="Nombre completo"required="">
                        </div>          
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="rut" id="inputPassword4"placeholder="17910085-0" required="">
                        </div>
                    </div>
                    <input type="submit" name="btn_registro_empleado" value="Crear nuevo empleado" class="btn btn-success py-3 px-5">
                </form>
            </section>            
        </main>
