<%-- 
    Document   : crear_factura
    Created on : 06-10-2020, 17:21:19
        ...
        <main class="fondo-principal text-light salto-linea">
            <section class="container border bg-secondary">
                ...
                <div class="my-3">                 
                    ...
                    <div class="my-3">
                        <a class="btn btn-warning py-3 px-5" href="listar_facturas.jsp">Listado facturas</a>
                        <a class="btn btn-info py-3 px-5" href="../facturacion.jsp">Volver</a>
                    </div>
                </div>                
            </section>          
        </main>
