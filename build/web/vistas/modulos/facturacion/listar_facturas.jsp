<%-- 
    Document   : listar_facturas
    Created on : 06-10-2020, 17:27:57
    ...
    <body>        
        ...
        <main class="bg-secondary text-dark">
            ...
            <section class="container border bg-light">                
                ...
                <c:if test = "${cant_lista_factura == false}">
                                ...
                                <tbody>
                                    <c:forEach var="listafac" items="${listadoFacturas}">                          
                                        <tr>
                                            ...
                                            <td>${listafac.getRut_empresa()}</td>
                                            <td>${listafac.getDireccion()}</td> 
                                            <td>${listafac.getFecha_creacion()}</td> 
                                            <td>${listafac.getCantidad_huespedes()}</td>  
                                            <td>${listafac.getMonto_total()}</td>  
                                        </tr>
                                    </c:forEach>
                                </tbody>
                ...
                <c:if test = "${cant_lista_factura == true}">
